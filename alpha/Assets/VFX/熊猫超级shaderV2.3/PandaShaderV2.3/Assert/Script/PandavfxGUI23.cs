...
public class PandavfxGUI23 : ShaderGUI
{
    ...
    static CreatMaskTex.RampTexType mainRampTexType;
    static CreatMaskTex.MaterialPropertise mainPropertise = new CreatMaskTex.MaterialPropertise("_MainTex",Color.white);
    static CreatMaskTex.RampTexType addRampTexType;
    static CreatMaskTex.MaterialPropertise addPropertise = new CreatMaskTex.MaterialPropertise("_AddTex", Color.white);
    static CreatMaskTex.RampTexType maskRampTexType;
    static CreatMaskTex.MaterialPropertise maskPropertise = new CreatMaskTex.MaterialPropertise("_MaskTex", Color.white);
    static CreatMaskTex.RampTexType maskPlusRampTexType;
    static CreatMaskTex.MaterialPropertise maskPlusPropertise = new CreatMaskTex.MaterialPropertise("_MaskPlusTex", Color.white);
    #region 主贴图字段
    private static Vector2 mainUVSpeed = Vector2.zero;

    private static ShaderGUIExpand.Custom custom = ShaderGUIExpand.Custom.Custom1;
    private static ShaderGUIExpand.Channel channel = ShaderGUIExpand.Channel.None;


    private static ShaderGUIExpand.Custom custom2 = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channel2 = ShaderGUIExpand.Channel.None;
    #endregion
    #region 多功能贴图字段
    private static Vector2 addUVSpeed = Vector2.zero;
    #endregion
    #region Mask贴图字段
    private static Vector2 maskUVSpeed = Vector2.zero;
    private static Vector2 maskUVSpeed2 = Vector2.zero;

    private static ShaderGUIExpand.Custom customMask = ShaderGUIExpand.Custom.Custom1;
    private static ShaderGUIExpand.Channel channelMask = ShaderGUIExpand.Channel.None;


    private static ShaderGUIExpand.Custom custom2Mask = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channel2Mask = ShaderGUIExpand.Channel.None;
    #endregion
    #region 溶解贴图字段
    private static Vector2 DissolveTexUVSpeed = Vector2.zero;

    private static ShaderGUIExpand.Custom customDissolve_UV = ShaderGUIExpand.Custom.Custom1;
    private static ShaderGUIExpand.Channel channelDissolve_UV = ShaderGUIExpand.Channel.None;


    private static ShaderGUIExpand.Custom custom2Dissolve_UV = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channel2Dissolve_UV = ShaderGUIExpand.Channel.None;

    private static ShaderGUIExpand.Custom customDissolve = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channelDissolve = ShaderGUIExpand.Channel.Z;
    #endregion
    #region UV扭曲贴图字段
    private static Vector2 DistortUVSpeed = Vector2.zero;

    private static ShaderGUIExpand.Custom customDistort = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channelDistort = ShaderGUIExpand.Channel.W;
    #endregion
    #region 顶点偏移贴图字段
    private static Vector2 VertexUVSpeed = Vector2.zero;

    private static ShaderGUIExpand.Custom customVertex = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channelVertex = ShaderGUIExpand.Channel.None;


    private static ShaderGUIExpand.Custom custom2Vertex = ShaderGUIExpand.Custom.Custom2;
    private static ShaderGUIExpand.Channel channel2Vertex = ShaderGUIExpand.Channel.None;
 ...
 //   MaterialProperty MainAlphaPower = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
     ...
     //   AddTexChanel= FindProperty("_AddTexChanel", props);
        ...
        DissolveTexUVS = ShaderGUI.FindProperty("_DissolveTexUVS", props);
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        ShaderGUIExpand.SelectM(material);
...
//
       ...
       EditorGUILayout.EndVertical();
        ...
        CreatMaskTex.RampShaderGUI(ref mainRampTexType, ref mainPropertise, ref material);
        ...
        if (mainTex_Sampler.textureValue != null) 
        {
            ...
            _Mainxx = Foldouts(_Mainxx, "贴图设置(点击打开)");
                 ...
                 if (_Mainxx)
                 {
                  ...
                  EditorGUILayout.BeginHorizontal();
                //EditorGUILayout.PrefixLabel("UVClamp");
                m_MaterialEditor.ShaderProperty(MainTexC, "UVClamp");
                m_MaterialEditor.ShaderProperty(MainTexCV,"");
                //ShaderGUIExpand.ShaderPropertyUVClamp(ref clamp, "UVClamp", ref MainTexC, ref MainTexCV);
                EditorGUILayout.EndHorizontal();
                GUILayout.Space(5);
                if (_tips == true)
                    {
            ...
            GUILayout.Space(5);
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref custom, ref channel, "U数据通道", ref MainOffsetUC1, ref MainOffsetUC2);
                GUILayout.Space(5);
                //m_MaterialEditor.ShaderProperty(MainOffsetVC1, "V数据");
                //m_MaterialEditor.ShaderProperty(MainOffsetVC2, "V通道");
                ShaderGUIExpand.ShaderPropertyCustom(ref custom2, ref channel2, "V数据通道", ref MainOffsetVC1, ref MainOffsetVC2);
                ...
                if (_tips == true)
            {
                ...
                style.fontSize = 10;
                style.normal.textColor = new Color(0.5f, 0.5f, 0.5f);
                GUILayout.Label("*包含normal默认UV，polar极坐标UV，cylinder圆筒UV三种模式，默认UV即模型自带UV，极坐标即中心向四周扩散UV，圆筒UV即世界坐标下一个圆筒包裹的UV，主帖图设置圆筒UV可以制作角色身上能量流动，或者渐变效果", style);
                EditorGUILayout.EndVertical();
            }
                ...
                if (material.GetFloat("_MainTexUVS") == 2)
            {
               ...
               //
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                ShaderGUIExpand.ShaderPropertyVector2(ref mainUVSpeed,ref MainUspeed, ref MainVspeed);
                EditorGUILayout.EndVertical();
...

    {
        ...
        CreatMaskTex.RampShaderGUI(ref maskRampTexType, ref maskPropertise, ref material);
...

        {
            ...
            if (material.GetFloat("_CustomdataMaskUV") == 1) { 
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref customMask, ref channelMask, "U数据通道", ref MaskOffsetUC1, ref MaskOffsetUC2);
                GUILayout.Space(5);
                ShaderGUIExpand.ShaderPropertyCustom(ref custom2Mask, ref channel2Mask, "V数据通道", ref MaskOffsetVC1, ref MaskOffsetVC2);
            ...
            if (_tips == true)
            {
                ...
                style.fontSize = 10;
                style.normal.textColor = new Color(0.5f, 0.5f, 0.5f);
                GUILayout.Label("*包含normal默认UV，polar极坐标UV，cylinder圆筒UV三种模式，默认UV即模型自带UV，极坐标即中心向四周扩散UV，圆筒UV即世界坐标下一个圆筒包裹的UV", style);
                EditorGUILayout.EndVertical();
            }
            ...
            ShaderGUIExpand.ShaderPropertyVector2(ref maskUVSpeed, ref MaskUspeed, ref MaskVspeed);
            ...
            GUILayout.Space(5);
                ...
                CreatMaskTex.RampShaderGUI(ref maskPlusRampTexType, ref maskPlusPropertise, ref material);
                ...
                ShaderGUIExpand.ShaderPropertyVector2(ref maskUVSpeed2, ref MaskPlusUspeed, ref MaskPlusVspeed);
...

    {
        ...
        if (Dissolve_Tex.textureValue != null)
        {
         ...
         //   GUILayout.Space(5);
            ...
            if (material.GetFloat("_IfDissolveOffsetC") == 1) {
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref customDissolve_UV, ref channelDissolve_UV, "U数据通道", ref DissolveOffsetUC1, ref DissolveOffsetUC2);
                GUILayout.Space(5);
                ShaderGUIExpand.ShaderPropertyCustom(ref custom2Dissolve_UV, ref channel2Dissolve_UV, "V数据通道", ref DissolveOffsetVC1, ref DissolveOffsetVC2);
        ...
        //    GUILayout.Space(5);
            ...
            if (material.GetFloat("_CustomdataDis") == 1) {
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref customDissolve, ref channelDissolve, "数据通道", ref DissolveFactorC1, ref DissolveFactorC2);
            ...
            m_MaterialEditor.ShaderProperty(DissolveTexUVS, "UV选择");
            if (_tips == true)
            {
                ...
                style.fontSize = 10;
                style.normal.textColor = new Color(0.5f, 0.5f, 0.5f);
                GUILayout.Label("*包含normal默认UV，polar极坐标UV，cylinder圆筒UV三种模式，默认UV即模型自带UV，极坐标即中心向四周扩散UV，圆筒UV即世界坐标下一个圆筒包裹的UV，溶解图设置圆筒UV可以制作世界坐标系下的出现和消失效果", style);
                EditorGUILayout.EndVertical();
            }


            if (material.GetFloat("_DissolveTexUVS") == 1)
            {
            ...
            ShaderGUIExpand.ShaderPropertyVector2(ref DissolveTexUVSpeed, ref Dissolve_Uspeed, ref Dissolve_Vspeed);
...

    {
        ...
        if (Distort_Tex.textureValue != null)
        {
            ...
            if (material.GetFloat("_CustomDistort") == 1)
            {
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref customDistort, ref channelDistort, "数据通道", ref DistortFactorC1, ref DistortFactorC2);
            ...
            ShaderGUIExpand.ShaderPropertyVector2(ref DistortUVSpeed, ref Distort_Uspeed, ref Distort_Vspeed);
      ...
      // 
        ...
        if (Vto_Tex.textureValue != null)
        {
            ...
            if (material.GetFloat("_ToggleSwitch0") == 1)
            {
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref customVertex, ref channelVertex, "数据通道", ref VTOFactorC1, ref VTOFactorC2);
                EditorGUILayout.EndVertical();
            ...
            ShaderGUIExpand.ShaderPropertyVector2(ref VertexUVSpeed, ref Vto_Uspeed, ref Vto_Vspeed);
        ...
        EditorGUILayout.EndVertical();
            ...
            if (material.GetFloat("_CustomVAT") == 1)
            {
                ...
                ShaderGUIExpand.ShaderPropertyCustom(ref custom2Vertex, ref channel2Vertex, "数据通道", ref VATFrameC1, ref VATFrameC2);
...

    {
        ...
        CreatMaskTex.RampShaderGUI(ref addRampTexType, ref addPropertise, ref material);
        if (_tips == true)
        {
...

        {
            ...
            ShaderGUIExpand.ShaderPropertyVector2(ref addUVSpeed, ref AddTexUspeed, ref AddTexVspeed);
